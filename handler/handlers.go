...
func (f *Facilitator) StateFromAdjacentDp(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "StateFromAdjacentDp, Marshall error", err)
...
func (f *Facilitator) StateFromRightDp(w http.ResponseWriter, r *http.Request) {
	...
	jsonData, err := json.Marshal(response)
	if err != nil {
		f.LogMessage("C", "StateFromRightDp, Marshall error", err)
		jsonData = []byte(`{"state": "0"}`)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) GetStateRightAndReceiveStateLeft(w http.ResponseWriter, r *http.Request) {
	...
	if f.DpStates.State == Quiesce2 {
		f.LogMessage("I", "GetStateRightAndReceiveStateLeft,f.dpStates.state == Quiesce2", nil)
		w.WriteHeader(http.StatusOK)
		return
	}
	...
	if err != nil {
		f.LogMessage("I", "GetStateRightAndReceiveStateLeft,could not convert query parameter state to int type", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "GetStateRightAndReceiveStateLeft, failure of getStateRight", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) GetStateLeftAndReceiveStateRight(w http.ResponseWriter, r *http.Request) {
	...
	// may be able to change state to dining
	if f.DpStates.State == Quiesce2 {
		f.LogMessage("I", "GetStateLeftAndReceiveStateRight,f.dpStates.state == Quiesce2", nil)
		w.WriteHeader(http.StatusOK)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "GetStateLeftAndReceiveStateRight, could not convert query parameter state to int type", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "GetStateLeftAndReceiveStateRight, failure of getStateLeft", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) Quiesce1Left(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "Quiesce1Left, Error json.Marshal(quiesce1LeftResponse)", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) Quiesce1Right(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "Quiesce1Right, Error json.Marshal(quiesce1RightResponse)", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) Quiesce2(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "Quiesce2, failure json.Marshal(quiesce2Response)", err)
		w.WriteHeader(http.StatusInternalServerError)
	}
...
func (f *Facilitator) DeQuiesce1Left(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "DeQuiesce1Left, failed to decode json response body", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "Error json.Marshal(DeQuiesce1Left)", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	w.Header().Set("Content-Type", "application/json")
...
func (f *Facilitator) DeQuiesce1Right(w http.ResponseWriter, r *http.Request) {
	...
	err = json.NewDecoder(response.Body).Decode(&responseMap)
	if err != nil {
		f.LogMessage("C", "DeQuiesce1Right, failed to decode json response body", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	jsonData, err := json.Marshal(responseMap)
	if err != nil {
		f.LogMessage("C", "DeQuiesce1Right, Error json.Marshal(responseMap)", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	w.Header().Set("Content-Type", "application/json")
...
func (f *Facilitator) DeQuiesce2(w http.ResponseWriter, r *http.Request) {
	...
	jsonData, err := json.Marshal(responseMap)
	if err != nil {
		f.LogMessage("C", "DeQuiesce2, Marshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	w.Header().Set("Content-Type", "application/json")
...
func (f *Facilitator) DeQuiesce3(w http.ResponseWriter, r *http.Request) {
	...
	jsonData, err := json.Marshal(responseMap)
	if err != nil {
		f.LogMessage("C", "DeQuiesce3, failure to Marshal(quiesce2Response)", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	w.Header().Set("Content-Type", "application/json")
...
func (f *Facilitator) DirectAddDp(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		jsonData, err := json.Marshal(responseMap)
		if err != nil {
			f.LogMessage("C", "DirectAddDp, failure Marshal", err)
		}
		w.Header().Set("Content-Type", "application/json")
		w.Write(jsonData)
		return
	...
	if err != nil {
		f.LogMessage("C", "DirectAddDp marshal request data failure", err)
		w.WriteHeader(http.StatusInternalServerError)
	...
	if err != nil {
		f.LogMessage("C", "DirectAddDp failure to create request, %v\n", err)
		w.WriteHeader(http.StatusInternalServerError)
	...
	if err != nil {
		...
		f.LogMessage("C", "DirectAddDp failure to send requestChangeOfAddress", err)
		w.WriteHeader(http.StatusInternalServerError)
	...
	if err != nil {
		f.LogMessage("C", "DirectAddDp NewDecoder Decode failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "DirectAddDp, Marshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	w.Header().Set("Content-Type", "application/json")
...
func (f *Facilitator) ReceiveRequestToRemoveDp(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "ReceiveRequestToRemoveDp, failure NewDecoder, Decode", err)
	...
	if informationToRemoveDp.DpNumberToBeRemoved == f.DpNumber {
		...
		err := f.removeDp()
		if err != nil {
			f.LogMessage("C", "ReceiveRequestToRemoveDp, failure to remove Dp", err)
			w.WriteHeader(http.StatusInternalServerError)
			return
		}
		...
		if err != nil {
			f.LogMessage("C", "ReceiveRequestToRemoveDp, f.relayRequestToRemoveDp failure ", err)
			w.WriteHeader(http.StatusInternalServerError)
			return
		}
	}
	...
	if err != nil {
		f.LogMessage("C", "ReceiveRequestToRemoveDp, Marshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) RelayRemoveDp(w http.ResponseWriter, r *http.Request) {
	...
	if informationToRemoveDp.Done == "true" {
		err = f.relayRequestToRemoveDp(&informationToRemoveDp)
		if err != nil {
			f.LogMessage("C", "RelayRemoveDp, relayRequestToRemoveDp failure", err)
			w.WriteHeader(http.StatusInternalServerError)
			return
		}
	}
	...
	if informationToRemoveDp.DpNumberToBeRemoved == f.DpNumber {
		...
		if err != nil {
			...
			f.LogMessage("C", "RelayRemoveDp, relayRequestToRemoveDp failure, Done has been set to true", err)
		} else {
			informationToRemoveDp.Result = "Dp removed successfully"
			f.LogMessage("I", "RelayRemoveDp, removeDp success", nil)
			if informationToRemoveDp.TerminateSelf == "true" {
				terminateSelf = true
			}
		}
		...
		if terminateSelf == true {
			f.LogMessage("I", "RelayRemoveDp, terminate self", nil)
			go func() {
				time.Sleep(time.Second * 30)
				os.Exit(0)
			}()
...
func (f *Facilitator) DirectRemoveDp(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "DirectRemoveDp marshal request data failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "DirectRemoveDp failure to create request", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		// error may require rollback here
		f.LogMessage("C", "DirectRemoveDp failure to send request", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) SetLeftAndRightAddressOfNewDp(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "SetLeftAndRightAddressOfNewDp, NewDecoder Decode failure", err)
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
	}
...
func (f *Facilitator) ReceiveRequestToAddNewDpToLeftOfTargetDp(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "ReceiveRequestToAddNewDpToLeftOfTargetDp, NewDecoder Decode failure", err)
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
	}
	...
	if informationToAddNewDp.TargetDpNumber == f.DpNumber {
		...
		if err != nil {
			f.LogMessage("C", "ReceiveRequestToAddNewDpToLeftOfTargetDp, failed", err)
			w.WriteHeader(http.StatusInternalServerError)
			return
		}
	...
	if err != nil {
		f.LogMessage("C", "Error json.Marshal(informationToAddNewDp)", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) AddNewDpToLeftOfTargetDp(w http.ResponseWriter, r *http.Request) {
	...
	err := json.NewDecoder(r.Body).Decode(&informationToAddNewDp)
	if err != nil {
		f.LogMessage("C", "AddNewDpToLeftOfTargetDp, NewDecoder Decode failure", err)
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
	}
	...
	if informationToAddNewDp.Done == "true" {
		err = f.relayRequestToAddNewDpToLeftOfTargetDp(&informationToAddNewDp)
		if err != nil {
			f.LogMessage("C", "AddNewDpToLeftOfTargetDp, relayRequestToAddNewDpToLeftOfTargetDp failure", err)
			w.WriteHeader(http.StatusInternalServerError)
			return
		}
		w.WriteHeader(http.StatusOK)
	...
	if informationToAddNewDp.TargetDpNumber == f.DpNumber {
		...
		err := f.addNewDpToLeftOfTargetDp(&informationToAddNewDp)
		if err != nil {
			f.LogMessage("C", "AddNewDpToLeftOfTargetDp, addNewDpToLeftOfTargetDp failure", err)
		...
		err = f.relayRequestToAddNewDpToLeftOfTargetDp(&informationToAddNewDp)
		if err != nil {
			f.LogMessage("C", "AddNewDpToLeftOfTargetDp, returnValueRelayRequest failure", err)
			w.WriteHeader(http.StatusInternalServerError)
			return
		}
	} else {
...
func (f *Facilitator) ChangeAddressOfAdjacentDp(w http.ResponseWriter, r *http.Request) {
	...
	err := json.NewDecoder(r.Body).Decode(&newPhilosopher)
	if err != nil {
		f.LogMessage("C", "ChangeAddressOfAdjacentDp, NewDecoder Decode failuer", err)
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
	}
	...
	jsonData, err := json.Marshal(responseMap)
	if err != nil {
		f.LogMessage("C", "ChangeAddressOfAdjacentDp, Marshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	w.Header().Set("Content-Type", "application/json")
...
func (f *Facilitator) DpAttributesReturn(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "DpAttributesReturn, failed to read body", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "DpAttributesReturn,failed to unmarshal body", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "DpAttributesReturn, RelayDpAttributesReturnRequest failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
}
...
func (f *Facilitator) DpAttributesRelay(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		f.LogMessage("W", "DpAttributesRelay, not a POST", nil)
	...
	body, err := io.ReadAll(r.Body)
	if err != nil {
		f.LogMessage("C", "DpAttributesRelay, failed to read body", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	err = json.Unmarshal(body, &dpAttributesRelay)
	if err != nil {
		f.LogMessage("C", "DpAttributesRelay,failed to unmarshal body", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "DpAttributesRelay, failed to convert previousSequenceNumber to an integer", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
getattributes:
	...
	if err != nil {
		f.LogMessage("C", "DpAttributesRelay, RelayDpAttributesRequest failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) StoreData(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		// do something
		f.LogMessage("W", "StoreData, not a POST", nil)
		w.WriteHeader(http.StatusMethodNotAllowed)
		return
	}
	...
	body, err := io.ReadAll(r.Body)
	if err != nil {
		f.LogMessage("C", "StoreData, ReadAll body failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "StoreData, Unmarshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) RequestDpAttributesRelay(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "RequestDpAttributesRelay, Marshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) RequestAttributesFromSingleDp(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "requestAttributesFromSingleDp, Marshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) DpResourceRelay(w http.ResponseWriter, r *http.Request) {
	...
	body, err := io.ReadAll(r.Body)
	if err != nil {
		f.LogMessage("C", "DpResourceRelay, ReadAll body failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "DpResourceRelay, Unmarshal failure", err)
		w.WriteHeader(http.StatusBadRequest)
		return
	}
...
func (f *Facilitator) RequestDpMessagesRelay(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "RequestDpMessagesRelay, relayDpMessagesRequest failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "RequestDpMessagesRelay, Marshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) RequestDpMessagesFromSingleDp(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		f.LogMessage("C", "requestDpMessagesFromSingleDp, Marshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) DpMessagesRelayHandler(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		f.LogMessage("W", "dpMessagesRelayHandler, not a POST", nil)
		w.WriteHeader(http.StatusMethodNotAllowed)
		return
	}
	...
	body, err := io.ReadAll(r.Body)
	if err != nil {
		f.LogMessage("C", "dpMessagesRelayHandler, ReadAll body failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "dpMessagesRelayHandler, Unmarshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
getdpmessages:
	...
	if err != nil {
		f.LogMessage("C", "dpMessagesRelayHandler, relayDpMessagesRequest failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	w.WriteHeader(http.StatusOK)
...
func (f *Facilitator) StoreOrRequestDpResourceInformation(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method != http.MethodPost {
		f.LogMessage("W", "StoreOrRequestDpResourceInformation, not a POST", nil)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	body, err := io.ReadAll(r.Body)
	if err != nil {
		f.LogMessage("C", "StoreOrRequestDpResourceInformation, ReadAll body failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "StoreOrRequestDpResourceInformation, Unmarshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	jsonData, err := json.Marshal(response)
	if err != nil {
		f.LogMessage("C", "StoreOrRequestDpResourceInformation Marshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (f *Facilitator) ChangeLeftOrRightAddress(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		f.LogMessage("W", "ChangeRightOrLeftAddressHandler, not a POST", nil)
		w.WriteHeader(http.StatusMethodNotAllowed)
		return
	}
	...
	body, err := io.ReadAll(r.Body)
	if err != nil {
		f.LogMessage("C", "ChangeRightOrLeftAddressHandler, ReadAll body failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		f.LogMessage("C", "ChangeRightOrLeftAddressHandler, Unmarshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	default:
		f.LogMessage("C", "ChangeRightOrLeftAddressHandler, invalid data, side must be Left or Right", err)
		w.WriteHeader(http.StatusBadRequest)
		return
	}
...
// requestToLogMessage
// *
func (f *Facilitator) RequestToLogMessage(w http.ResponseWriter, r *http.Request) {

	body, err := io.ReadAll(r.Body)
	if err != nil {
		f.LogMessage("C", "RequestToLogMessage, ReadAll body failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	...
	err = json.Unmarshal(body, &foreignLogMessage)
	if err != nil {
		f.LogMessage("C", "RequestToLogMessage, Unmarshal failure", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}

	message := fmt.Sprintf("requestor number: %s, requestor address: %s, message: %s",
